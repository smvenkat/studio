...
import { LoadCraftK6Logo } from "@/components/icons";
...
export default function LoadCraftK6Client() {
  ...
  const handleDownloadArchive = async () => {
    ...
    try {
      ...
      const a = document.createElement("a");
      a.href = url;
      a.download = 'loadcraft-k6-artifacts.zip';
      document.body.appendChild(a);
      a.click();
      document.body.removeChild(a);
      URL.revokeObjectURL(url);
      toast({ title: "Download Started", description: `loadcraft-k6-artifacts.zip is downloading.` });
  ...
  return (
    <div className="w-full max-w-6xl space-y-8">
      <div className="flex flex-col items-center space-y-2 text-center">
        <LoadCraftK6Logo className="h-12 w-12 text-primary" />
